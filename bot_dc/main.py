...
@bot.command()
async def sai(ctx:commands.Context):
...
@bot.command()
async def cacete(ctx: commands.Context):
        ...
        audio_source = FFmpegPCMAudio('c:\\Users\\Guilherme\\Desktop\\projetos_python\\bot_dc\\cacete.mp3')
...
@bot.command()
async def estourado4(ctx: commands.Context):
        ...
        audio_source = FFmpegPCMAudio('c:\\Users\\Guilherme\\Desktop\\projetos_python\\bot_dc\\arabe.mp3')
        voice_client.play(audio_source)

@bot.command()
async def estourado5(ctx: commands.Context):
        ...
        audio_source = FFmpegPCMAudio('c:\\Users\\Guilherme\\Desktop\\projetos_python\\bot_dc\\domdom.mp3')
        voice_client.play(audio_source)
